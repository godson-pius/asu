<?php
$headerTitle = "devotion";
require_once 'components/header.php';

if (isset($_GET['devotion'])) {
    $devotion_slug = $_GET['devotion'];

    $devotion = EXECUTE_SINGLE_ROW_QUERY(SELECT_WHERE("devotions", "devotion_slug", $devotion_slug));

    extract($devotion);

   $comment_count = GET_TOTAL_WHERE_WITH_AND_CLAUSE("comments", "post_id", $devotion_id, "type", "d");

    $like_count = GET_TOTAL_WHERE_WITH_AND_CLAUSE("likes", "liked_id", $devotion_id, "type", "d");

    $all_comments = EXECUTE_QUERY(SELECT_WHERE_WITH_AND_CLAUSE("comments", "post_id", $devotion_id, "type", "d"));
...
if (isset($_POST['submit_comment'])) {
    ...
    $sql = "INSERT INTO comments (post_id, member, comment, type) VALUES ($devotion_id, '$member', '$comment', 'd')";
                        ...
                        <div class="inner-content">
                            <div class="breadcrumb-menu" data-aos="fade-down" data-aos-easing="linear"
                                ...
                                <ul>
                                    ...
                                    <li class="active">Devotion Details</li>
                                </ul>
                            </div>

                            <div class="title" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
                                <h2>Devotion Details</h2>
                            </div>
                            ...
                            <div class="single-blog-style1 single-blog-style1--instyle3">
                                <div class="single-blog-style1__inner">
                                    <div class="img-holder">
                                        <div class="inner">
                                            <!-- 770 * 420 -->
                                            <div style="width: 770px; height: 420px; background-image: url(assets/images/devotions/<?= $devotion_img; ?>); background-position: center; background-size: cover;">
                                                    </div>
                                        </div>
                                        <div class="date-box">
                                    ...
                                    <div class="text-holder">
                                        <ul class="meta-info">
                                            ...
                                            <li style="cursor: pointer;">
                                                <i data-liked="<?= $devotion_id; ?>" data-type="d" data-member="<?= $_SESSION['member']; ?>" onclick="likePost(this)" class="<?= $like_style; ?>" aria-hidden="true"></i>
                                                <a id="total"><?= $like_count; ?> likes</a>
                                            </li>

                                        </ul>
                                        <div class="text-inner">
                                            <h3 class="blog-title"><?= $devotion_title; ?></h3>
                                        </div>
                                        <div class="text">
                                            <p><?= $devotion_body; ?></p>
                                        </div>
