        ...
        <div class="banner-carousel owl-theme owl-carousel">
            ...
            <div class="slide">
                ...
                <div class="auto-container">
                    <div class="content">
                        <div class="sub-title">
                            <h3>Welcome to Anambra State Union</h3>
                        </div>
                        <div class="big-title">
                            <h2>
            ...
            <div class="col-xl-6">
                <div class="about-style1__content">
                    <div class="sec-title">
                        ...
                        <h2>Anambra State Union <br> <h5>Our Objectives</h5></h2> 
                    </div>
                    <div class="inner-content">
                        <div class="text">
                            <p>ASU UK aims to foster unity among the people of Anambra State origin that are resident in the United Kingdom of Great Britain and Northern Ireland…</p>
                        </div>
                        ...
                        <div class="about-style1__bottom-content">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="text-box">
                                        <ul>
                                            <li>SPIRIT OF UNITY AMONG ALL PEOPLE OF ANAMBRA STATE</li>
                                            <li>PROJECT THE CULTURE AND IMAGE OF ANAMBRA STATE</li>
                                            <li>PROMOTE, PROTECT AND DEFEND THE COMMON INTEREST</li>
                                            <li>ENCOURAGE PEACEFUL COEXISTENCE BETWEEN MEMBERS</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
