                ...
                <div class="col-xl-6 col-lg-4 col-md-4 col-sm-12">
                    <div class="single-footer-widget marbtm50">
                        ...
                        <div class="our-company-info">
                            <div class="text-box">
                                <p>ASU UK aims to foster unity among the people of Anambra State origin that are
                                    resident in the United Kingdom of Great Britain and Northern Ireland.</p>
                            </div>
                            <div class="footer-social-link">
                                <ul class="clearfix">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/invites/contact/?i=1or5kzvwyf6a7&utm_content=rbfs4j3"><i class="icon-instagram" target="_blank"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            <p>
                                                <a href="mailto:info@anambrastateunion.org.uk ">info@anambrastateunion.org.uk </a>
                                            </p>
                                        </div>
                                    </div>
                                </li>
